...
- (instancetype)initWithCameraName:(NSString *)cameraName
  ...
  [_captureDevice setExposureModeCustomWithDuration:CMTimeMake(1, 1000) ISO:880 completionHandler:nil];
  // [self applyFocusMode:true onDevice:_captureDevice];
  [_captureDevice setFocusMode:AVCaptureFocusModeContinuousAutoFocus];
  [_captureDevice setSmoothAutoFocusEnabled:true];
